package com.localisation.configs;
...
public class OpenApiConfig {
	...
	public OpenAPI customOpenAPI(@Value("${application-description}") String appDesciption, 
		...
		return new OpenAPI()
				.info(new Info()
						.title("PharmaFinder Morocco API")
				.version(appVersion)
				.contact(getContact())
	 ...
	 private Contact getContact() {
        ...
        contact.setEmail("bibzazne@gmail.com");
        contact.setName("HansLanda");
        contact.setUrl("https://www.github.com/hanslanda14ib");
